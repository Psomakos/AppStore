...
INSERT INTO RATING (info) VALUES
(
  '{"Rating_ID":"1", "App_ID": "APP1", "App_Rating_Value": "4", "App_Rating_Date": "2024-03-10"}'
),
(
  '{"Rating_ID": "5", "App_ID": "APP1", "App_Rating_Value": "3", "App_Rating_Date": "2020-08-29"}'
),
(
  '{"Rating_ID": "2", "App_ID": "APP2", "App_Rating_Value": "5", "App_Rating_Date": "2024-05-15"}'
),
(
  '{"Rating_ID": "6", "App_ID": "APP2", "App_Rating_Value": "4", "App_Rating_Date": "2024-06-18"}'
),
(
  '{"Rating_ID": "3", "App_ID": "APP3", "App_Rating_Value": "5", "App_Rating_Date": "2023-04-22"}'
),
(
  '{"Rating_ID": "4", "App_ID": "APP4", "App_Rating_Value": "2", "App_Rating_Date": "2022-07-15"}'
);
...
FROM APP a
JOIN RATING r ON a.App_ID = r.info ->> 'App_ID';

--2
SELECT
  info ->> 'Rating_ID' AS Rating_ID,
  info ->> 'App_ID' AS App_ID,
  info ->> 'App_Rating_Value' AS App_Rating_Value,
  info ->> 'App_Rating_Date' AS App_Rating_Date
FROM RATING;
...
FROM APP a
JOIN RATING r ON a.App_ID = r.info ->> 'App_ID'
WHERE CAST(r.info ->> 'App_Rating_Value' AS INT) > 3;
